<template>
  <div class="post">
    ...
    <div class="row">
      ...
      <form ref="formUpload" enctype="multipart/form-data" class="col s6">
        ...
        <div class="input-field col s12">
          <p v-for="(categorie,index) in categories">
            <input :value="categorie" v-model="newPost.categorie" name="group1" type="radio" :id="index" />
            <label :for="index">{{ categorie }}</label>
          </p>
        </div>
